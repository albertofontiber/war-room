...
export default function Navbar() {
  ...
  return (
    <header className="h-11 flex-shrink-0 flex items-center px-4 gap-3 border-b border-wr-border bg-wr-surface">
      ...
      {/* BORME badge — placeholder */}
      <button className="relative p-1.5 rounded-md border border-wr-border text-wr-muted hover:text-wr-amber transition-colors">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
          <path d="M13.73 21a2 2 0 0 1-3.46 0" />
        </svg>
        <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-wr-amber rounded-full animate-pulse" />
      </button>
